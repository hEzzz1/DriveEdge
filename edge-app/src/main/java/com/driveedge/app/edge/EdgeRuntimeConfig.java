...
public final class EdgeRuntimeConfig {
  ...
  private static final float DEFAULT_MIN_SIGNAL_CONFIDENCE = 0.60f;
  ...
  private static final long DEFAULT_DISTRACTION_HEAD_POSE_DURATION_MS = 3_500L;
  private static final double DEFAULT_DISTRACTION_HEAD_POSE_STABILITY_THRESHOLD = 0.72;
  private static final double DEFAULT_DISTRACTION_HEAD_DOWN_THRESHOLD = 0.62;
  private static final long DEFAULT_DISTRACTION_HEAD_DOWN_DURATION_MS = 2_500L;
  private static final double DEFAULT_DISTRACTION_GAZE_OFFSET_THRESHOLD = 0.68;
  private static final long DEFAULT_DISTRACTION_GAZE_OFFSET_DURATION_MS = 2_500L;
